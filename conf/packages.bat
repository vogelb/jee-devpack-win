...
set DEVPACK_PACKAGES=ANSICON JDK8 JDK8_32 JDK7 JDK6 JDK8_APIDOC ECLIPSE_EE ECLIPSE_JAVA ECLIPSE_CPP ECLIPSE_WORKSPACE MAVEN TOMEE WILDFLY GLASSFISH NOTEPAD ATOM FORGE SCALA CONSOLE SOURCETREE GIT MELD POSTGRES BABUN NODE GITBOOK GITBOOK_EDITOR VAGRANT
...
set VAGRANT_NAME=VAGRANT
set VAGRANT_VERSION=1.9.5
set VAGRANT_URL=https://releases.hashicorp.com/vagrant/1.9.5/vagrant_1.9.5.msi
set VAGRANT_TYPE=MSI
set VAGRANT_PACKAGE=vagrant_1.9.5.msi
